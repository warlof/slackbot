...
use Warlof\Seat\Slackbot\Jobs\Workers\SlackAssKicker;
use Warlof\Seat\Slackbot\Jobs\Workers\SlackReceptionist;

class SlackUpdater implements ShouldQueue
{
    ...
    public function __construct(JobPayloadContainer $jobPayload)
    {
        ...
        // Setup workers
        $this->workers = [
            SlackReceptionist::class,
            SlackAssKicker::class
        ];
    }
    ...
    public function handle()
    {
        ...
        // iterate over all Slack bot workers
